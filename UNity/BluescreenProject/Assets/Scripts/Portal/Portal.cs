...
public class Portal : MonoBehaviour
{
    ...
    public void Render()
    {
        ...
        for (int i = 0; i < recursionLimit; i++)
        {
            ...
            renderPositions[renderOrderIndex].y = 1.72f;

            portalCam.transform.SetPositionAndRotation(renderPositions[renderOrderIndex], renderRotations[renderOrderIndex]); ///guh
        ...
        {
            renderPositions[i].y = 1.72f;
            portalCam.transform.SetPositionAndRotation(renderPositions[i], renderRotations[i]); //guh
            SetNearClipPlane();
            HandleClipping();
            portalCam.Render();
    ...
    float ProtectScreenFromClipping(Vector3 viewPoint)
    {
        ...
        screenT.localPosition = screenT.localPosition * screenThickness * ((camFacingSameDirAsPortal) ? 0.5f : -0.5f);// One camera too low
